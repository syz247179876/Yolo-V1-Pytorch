...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument('--start_epoch', type=int, default=27)
        ...
        self.parser.add_argument('-lr', type=float, default=.0001)
        self.parser.add_argument("--weight_decay", type=float, default=1e-4)
        # 用于断点训练
        self.parser.add_argument('--pretrain', type=str, default=r'./checkpoints_dir/epoch26.pkl')
    ...
    def set_test_args(self):
        ...
        self.parser.add_argument('--model_dir', type=str,
                                 default=r'./checkpoints_dir/epoch26.pkl')
