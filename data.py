...
# train_dataset = YOLOV1Dataset(mode='train')
# validate_dataset = YOLOV1Dataset(mode='validate')
# test_dataset = YOLOV1Dataset(mode='test')
#
# train_loader = DataLoader(train_dataset, batch_size=10, shuffle=True, drop_last=True)
# validate_dataset = DataLoader(validate_dataset, batch_size=10, shuffle=True, drop_last=True)
# test_dataset = DataLoader(test_dataset, batch_size=10, shuffle=True, drop_last=True)

# if DEBUG_OPEN:
#     for batch_idx, (_, label) in enumerate(test_dataset):
#         print(f'{batch_idx} {label}')
